...
//	        runPackage(10,port,_util.short2array(speed));
    ...
    ext._getStatus = function() {
        if(!_device) return {status: 1, msg: 'Self Driving Car disconnected'};
        if(watchdog) return {status: 1, msg: 'Probing for Self Driving Car'};
        return {status: 2, msg: 'Self Driving Car connected'};
    }

    var descriptor = {};
	ScratchExtensions.register('Self Driving Car', descriptor, ext, {type: 'serial'});
})({});
