...
//	        runPackage(10,port,_util.short2array(speed));
    ...
    ext._getStatus = function() {
        if(!_device) return {status: 1, msg: 'Arduino Sensors & Actuators disconnected'};
        if(watchdog) return {status: 1, msg: 'Probing for Arduino Sensors & Actuators'};
        return {status: 2, msg: 'Arduino Sensors & Actuators connected'};
    }

    var descriptor = {};
	ScratchExtensions.register('Arduino Sensors & Actuators', descriptor, ext, {type: 'serial'});
})({});
