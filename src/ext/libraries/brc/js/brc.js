...
//	        runPackage(10,port,_util.short2array(speed));
    ...
    ext._getStatus = function() {
        if(!_device) return {status: 1, msg: 'Bluetooth RC Car disconnected'};
        if(watchdog) return {status: 1, msg: 'Probing for Bluetooth RC Car'};
        return {status: 2, msg: 'Bluetooth RC Car connected'};
    }

    var descriptor = {};
	ScratchExtensions.register('Bluetooth RC Car', descriptor, ext, {type: 'serial'});
})({});
