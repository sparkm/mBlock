...
//	        runPackage(10,port,_util.short2array(speed));
    ...
    ext._getStatus = function() {
        if(!_device) return {status: 1, msg: 'Line Following Robot disconnected'};
        if(watchdog) return {status: 1, msg: 'Probing for Line Following Robot'};
        return {status: 2, msg: 'Line Following Robot connected'};
    }

    var descriptor = {};
	ScratchExtensions.register('Line Following Robot', descriptor, ext, {type: 'serial'});
})({});
